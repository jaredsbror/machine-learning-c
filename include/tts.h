...
PiperVoice piper_voices[] = {
    ...
    // English (en_US)
    { "en_US", "amy (low)", "../piper/piper-voices/en/en_GB/amy/low/en_US-amy-low.onnx" },
    { "en_US", "amy (medium)", "../piper/piper-voices/en/en_GB/amy/medium/en_US-amy-medium.onnx" },
    { "en_US", "arctic (medium)", "../piper/piper-voices/en/en_GB/arctic/medium/en_US-arctic-medium.onnx" },
    { "en_US", "bryce (medium)", "../piper/piper-voices/en/en_GB/bryce/medium/en_US-bryce-medium.onnx" },
    { "en_US", "danny (low)", "../piper/piper-voices/en/en_GB/danny/low/en_US-danny-low.onnx" },
    { "en_US", "hfc_female (medium)", "../piper/piper-voices/en/en_GB/hfc_female/medium/en_US-hfc_female-medium.onnx" },
    { "en_US", "hfc_male (medium)", "../piper/piper-voices/en/en_GB/hfc_male/medium/en_US-hfc_male-medium.onnx" },
    { "en_US", "joe (medium)", "../piper/piper-voices/en/en_GB/joe/medium/en_US-joe-medium.onnx" },
    { "en_US", "john (medium)", "../piper/piper-voices/en/en_GB/john/medium/en_US-john-medium.onnx" },
    { "en_US", "kathleen (low)", "../piper/piper-voices/en/en_GB/kathleen/low/en_US-kathleen-low.onnx" },
    { "en_US", "kristin (medium)", "../piper/piper-voices/en/en_GB/kristin/medium/en_US-kristin-medium.onnx" },
    { "en_US", "kusal (medium)", "../piper/piper-voices/en/en_GB/kusal/medium/en_US-kusal-medium.onnx" },
    { "en_US", "l2arctic (medium)", "../piper/piper-voices/en/en_GB/l2arctic/medium/en_US-l2arctic-medium.onnx" },
    { "en_US", "lessac (low)", "../piper/piper-voices/en/en_GB/lessac/low/en_US-lessac-low.onnx" },
    { "en_US", "lessac (medium)", "../piper/piper-voices/en/en_GB/lessac/medium/en_US-lessac-medium.onnx" },
    { "en_US", "libritts_r (medium)", "../piper/piper-voices/en/en_GB/libritts_r/medium/en_US-libritts_r-medium.onnx" },
    { "en_US", "ljspeech (medium)", "../piper/piper-voices/en/en_GB/ljspeech/medium/en_US-ljspeech-medium.onnx" },
    { "en_US", "norman (medium)", "../piper/piper-voices/en/en_GB/norman/medium/en_US-norman-medium.onnx" },
    { "en_US", "ryan (low)", "../piper/piper-voices/en/en_GB/ryan/low/en_US-ryan-low.onnx" },
    { "en_US", "ryan (medium)", "../piper/piper-voices/en/en_GB/ryan/medium/en_US-ryan-medium.onnx" },
